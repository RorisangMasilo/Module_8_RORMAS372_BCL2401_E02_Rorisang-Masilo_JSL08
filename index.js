// This one will be a little tricky. So check out this overview first: [Singleton Design Pattern – How it Works in JavaScript with ...](https://www.freecodecamp.org/news/singleton-design-pattern-with-javascript/)
...
// - We demonstrate the Singleton pattern by creating two instances (`branchA` and `branchB`) and show that they both point to the same instance, ensuring that there is only one set of branch information throughout the application.
